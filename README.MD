...
<ol>
  ...
  <li>Configura la base de datos en <code>soundplus/settings.py</code></li>

  <li>Ejecuta las migraciones de la base de datos: <code>python manage.py migrate</code></li>
